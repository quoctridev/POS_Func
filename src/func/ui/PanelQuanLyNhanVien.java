...
public class PanelQuanLyNhanVien extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setVerticalGroup(
            jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(lbMenu, javax.swing.GroupLayout.DEFAULT_SIZE, 60, Short.MAX_VALUE)
        );
...
//        showTable();
        ...
        if (user == null) {
            ...
            if (user != null) {
                DialogSuaNhanVien sua = new DialogSuaNhanVien((Frame) SwingUtilities.getWindowAncestor(this), true);
                sua.setUser(user);
...
//                }
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        // TODO add your handling code here:
        new DialogThemNhanVien((Frame) SwingUtilities.getWindowAncestor(this), true).setVisible(true);
        showTable();
