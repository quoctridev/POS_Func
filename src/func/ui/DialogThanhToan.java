 ...
 * @author quoca
 */
public class DialogThanhToan extends javax.swing.JDialog {
     ...
     */
    public DialogThanhToan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        lbChuyenKhoan.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        lbTienMat.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        lbTienHang.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        ...
        btnApDung.setForeground(new java.awt.Color(0, 0, 0));
        ...
        jPanel7.setBackground(new java.awt.Color(137, 137, 229));

        jLabel9.setBackground(new java.awt.Color(137, 137, 229));
...
//            });
    ...
    private void btnApDungActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnApDungActionPerformed
        ...
        if (txtMaGiamGia.getText().trim().isEmpty()) {
            ...
            if (dc == null) {
                ...
                return;
            } else if (!DialogMaGiamGia.isCurrentDateInRange(dc)) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogThanhToan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogThanhToan dialog = new DialogThanhToan(new javax.swing.JFrame(), true);
