...
public class JDialogQRThanhToan extends javax.swing.JDialog {
     ...
     */
    public JDialogQRThanhToan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
...
String callAPI(String amount) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialogQRThanhToan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDialogQRThanhToan dialog = new JDialogQRThanhToan(new javax.swing.JFrame(), true);
