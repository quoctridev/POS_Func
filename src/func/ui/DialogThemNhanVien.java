 ...
 * @author ASUS
 */
public class DialogThemNhanVien extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogThemNhanVien.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogThemNhanVien dialog = new DialogThemNhanVien(new javax.swing.JFrame(), true);
